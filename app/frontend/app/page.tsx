    ...
    <div className="min-h-screen">
          ...
          {services.map((service) => {
            ...
            return (
              <Link href={service.path} key={service.id}>
                <div
                  className="service-card bg-white border border-slate-200 rounded-3xl p-8 shadow-sm hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer h-full"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {featuredCovers.map((cover, index) => (
            <Link href="/covers" key={index}>
              <div
                className="product-card bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg cursor-pointer hover:scale-105 transition-all duration-300"
              ...
              >
                ...
                <div className="p-4">
                  <p className="font-semibold text-slate-900 text-center">{cover.title}</p>
                </div>
              </div>
            </Link>
          ))}
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="bg-slate-100 rounded-3xl p-12 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-6">Why Choose Teez-Flexx?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-slate-600">Trained professionals with years of experience</p>
            </div>
            <div>
              <div className="bg-emerald-600 text-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 text-2xl font-bold">✓</div>
              <h3 className="text-xl font-bold text-slate-900 mb-2">Quality Assured</h3>
              <p className="text-slate-600">All devices tested and verified before sale</p>
            </div>
            <div>
              <div className="bg-emerald-600 text-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 text-2xl font-bold">✓</div>
              <h3 className="text-xl font-bold text-slate-900 mb-2">Best Support</h3>
              <p className="text-slate-600">24/7 customer support via WhatsApp</p>
            </div>
          </div>
        </div>
      </section>
